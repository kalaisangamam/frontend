    ...
    <div className="container-xl grid grid-cols-1 md:grid-cols-4 gap-10">
      <div>
        ...
        <div className="flex gap-4 mt-5 text-lg text-parchment-300">
          {site?.facebook && <a href={site.facebook} aria-label="Facebook" className="transition-colors hover:text-brass-400"><FiFacebook /></a>}
          {site?.instagram && <a href={site.instagram} aria-label="Instagram" className="transition-colors hover:text-brass-400"><FiInstagram /></a>}
          {site?.youtube && <a href={site.youtube} aria-label="YouTube" className="transition-colors hover:text-brass-400"><FiYoutube /></a>}
        </div>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm text-parchment-300">
          <li><Link to="/about" className="transition-colors hover:text-brass-400">About Us</Link></li>
          <li><Link to="/masters" className="transition-colors hover:text-brass-400">Masters</Link></li>
          <li><Link to="/gallery" className="transition-colors hover:text-brass-400">Gallery</Link></li>
          <li><Link to="/events" className="transition-colors hover:text-brass-400">Upcoming Events</Link></li>
          <li><Link to="/contact" className="transition-colors hover:text-brass-400">Contact</Link></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <div className="flex gap-3 mt-5">
          <Link to="/student/login" className="text-xs text-brass-500 underline underline-offset-4 hover:text-brass-400">Student Login</Link>
          <Link to="/admin/login" className="text-xs text-slate-500 underline underline-offset-4 hover:text-brass-400">Admin Login</Link>
        </div>
      </div>
    </div>

    <div className="container-xl mt-12 pt-6 border-t border-parchment-100/10 text-xs text-slate-500 flex flex-col sm:flex-row justify-between gap-2">
